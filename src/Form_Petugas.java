...
public class Form_Petugas extends javax.swing.JFrame {
    ...
    public void Simpan() {
        ...
        if (id.isEmpty() || nama.isEmpty() || user.isEmpty() || pass.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Data tidak lengkap, silakan lengkapi semua field!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void Delete() {
        ...
        if (id.isEmpty()) {
            JOptionPane.showMessageDialog(this, "ID Petugas tidak boleh kosong!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Aesthetician_B_h.png"))); 
    ...
    private void btnupdateComponentAdded(java.awt.event.ContainerEvent evt) {
    }

    private void txtpassActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void btnkodeActionPerformed(java.awt.event.ActionEvent evt) {
        Autonomor();
    }
    ...
    private void tabelpetugasMouseClicked(java.awt.event.MouseEvent evt) {
